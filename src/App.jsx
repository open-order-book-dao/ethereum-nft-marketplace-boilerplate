...
const App = ({isServerInfo}) => {
    ...
    const inputValueFromUrl = useMemo(() => {
        const searchParams = new URLSearchParams(location.search);
        return searchParams.get('input-value') ?? 'explore';
    }, [location]);

    const [inputValue, setInputValueInternal] = useState(inputValueFromUrl);

    useEffect(() => {
        console.log('inputValueFromUrl', inputValueFromUrl);
        setInputValueInternal(inputValueFromUrl);
    }, [inputValueFromUrl, setInputValueInternal]);

    const setInputValue = useCallback((value) => {
        console.log('setInputValue', value);
        const searchParams = new URLSearchParams(location.search);
        searchParams.set('input-value', value);
        history.push({
